...
import dev.jeffersonfreitas.api.core.recommendation.RecommendationService;
import dev.jeffersonfreitas.api.core.review.Review;
import dev.jeffersonfreitas.api.core.review.ReviewService;
...
import dev.jeffersonfreitas.util.http.HttpErrorInfo;
...
public class ProductCompositeIntegration implements ProductService, RecommendationService, ReviewService{
	...
	public List<Review> getReviews(int productId) {
		try {
			...
			LOG.warn("Got an expection while requesting reviews, return zero reviews: {}", ex.getMessage());
